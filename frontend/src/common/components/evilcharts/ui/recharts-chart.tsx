/* eslint react-refresh/only-export-components: ["warn", { "allowExportNames": ["useChart", "getPayloadConfigFromPayload", "getLoadingData", "axisValueToPercentFormatter", "getColorsCount"] }] */
...
function ChartContainer({
  ...
  return (
    <ChartContext.Provider value={{ config, containerRef }}>
      <div
        ref={containerRef}
        data-slot="chart"
        data-chart={chartId}
