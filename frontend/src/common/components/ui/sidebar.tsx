  ...
  return (
    <ScrollArea.Root
      ...
      className={cn(
        ...
        'before:pointer-events-none before:absolute before:inset-x-0 before:top-0 before:z-10 before:h-4 before:bg-linear-to-b before:from-sidebar before:to-transparent before:opacity-0 before:transition-opacity data-overflow-y-start:before:opacity-100',
        'after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:z-10 after:h-4 after:bg-linear-to-t after:from-sidebar after:to-transparent after:opacity-0 after:transition-opacity data-overflow-y-end:after:opacity-100',
        className,
      )}
      {...props}
    >
      <ScrollArea.Viewport
        ...
        className="h-full w-full overscroll-contain focus-visible:-outline-offset-2"
        style={{ overflowX: 'hidden' }}
      >
        <ScrollArea.Content
          className="flex flex-col gap-0 overflow-x-clip"
          style={{ minWidth: 0 }}
        >
          {children}
        </ScrollArea.Content>
      ...
      >
        <ScrollArea.Thumb
          ...
          className="w-full rounded-full bg-sidebar-foreground/30 hover:bg-sidebar-foreground/50"
        />
      </ScrollArea.Scrollbar>
    </ScrollArea.Root>
  );
