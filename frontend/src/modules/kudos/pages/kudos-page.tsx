              ...
              >
                <div className="grid max-w-lg gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    <Label htmlFor="kudos-token">Emoji or Slack token</Label>
                    <Input
                      id="kudos-token"
                      maxLength={16}
                      required
                ...
                >
                  ...
                  <p className="border-l-2 pl-3 text-muted-foreground">
                    Caught a DST bug that would have affected the whole team.
                  </p>
                  ...
                  {preview.emoji?.startsWith(':') &&
                    preview.emoji !== ':morgenruf:' && (
                      <p className="text-xs text-muted-foreground">
                        Slack will show this custom emoji if it exists in your
                        workspace.
                      </p>
                    )}
                </div>
